...
# Error messages
error =
    .duplicate-medication = Medication {$name} previously added

# -------------------------------------
# Welcome Page
welcome-heading = Script Pilot

welcome-para-01 =
    Script Pilot helps keep track of medicines, prescriptions and repeats in one place.
...
welcome-para-02 =
    ...
    Script Pilot is a personal organiser to help manage prescription records.
...
terms-para-02 =
    Although every effort has been made to make Script Pilot reliable, no guarantee is
    ...
    The authors of Script Pilot accept no liability for any loss, damage or injury arising
    from its use.

terms-para-03 =
    Script Pilot stores only the information entered into the application.
...
terms-para-04 =
    Script Pilot may be updated from time to time to add features, improve reliability
    or correct defects.
...
# -------------------------------------
# Medications panel
medications-first-para-01 = Add current medications.

medications-first-para-02 = These details can be changed later.
